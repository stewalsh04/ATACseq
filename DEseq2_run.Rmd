...
```{r}
myfile <-"/ifs/projects/proj078/1_atac_seq/4_data_for_steve/attempt_1/Peak_counts.csv"
myfile2 <- "/ifs/projects/proj078/1_atac_seq/SteveW_Rproject/sample_sheet.csv"
peakfile <- "/ifs/projects/proj078/1_atac_seq/4_data_for_steve/peakcalling_Jul18/mm_ATACCT16LightPulse30v1v2_R1.macs2_peaks.narrowPeak"
genetocheck <-"fos"
```
...
#myfile <- "/ifs/projects/proj078/1_atac_seq/SteveW_Rproject/Peak_counts.csv"
#myfile2 <- "/ifs/projects/proj078/1_atac_seq/SteveW_Rproject/sample_sheet.csv"
